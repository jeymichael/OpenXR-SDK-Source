...
struct OpenGLESGraphicsPlugin : public IGraphicsPlugin {
    ...
    bool increment_rotate(int dir) {
        ...
        if (dir < 0) rotateCurrent += (-0.25f);
        else rotateCurrent += (0.25f);
    ...
    void rotate_R() {
        ...
        if (!increment_rotate(-1)) {
            ...
            reset_subCube_colors(10); reset_subCube_colors(11); reset_subCube_colors(12); reset_subCube_colors(13);
    ...
    void rotate_L() {
        ...
        if (!increment_rotate(1)) {
            ...
            reset_subCube_colors(6); reset_subCube_colors(7); reset_subCube_colors(8); reset_subCube_colors(9);
    ...
    void rotate_U() {
        ...
        if (!increment_rotate(-1)) {
            ...
            reset_subCube_colors(7); reset_subCube_colors(11); reset_subCube_colors(16); reset_subCube_colors(17);
    ...
    void rotate_D() {
        ...
        if (!increment_rotate(1)) {
            ...
            reset_subCube_colors(6); reset_subCube_colors(10); reset_subCube_colors(14); reset_subCube_colors(15);
    ...
    void rotate_F() {
        ...
        if (!increment_rotate(-1)) {
            ...
            reset_subCube_colors(9); reset_subCube_colors(13); reset_subCube_colors(15); reset_subCube_colors(17);
    ...
    void rotate_B() {
        ...
        if (!increment_rotate(1)) {
            ...
            reset_subCube_colors(8); reset_subCube_colors(12); reset_subCube_colors(14); reset_subCube_colors(16);
